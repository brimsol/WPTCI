    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right box-tools">
                <a href="<?php echo site_url('admin/customers/'); ?>"> <button title="" data-toggle="tooltip" class="btn btn-primary btn-sm refresh-btn" data-original-title="Add New"><i class="fa fa-plus"></i></button></a>
            </div>
        </div>
